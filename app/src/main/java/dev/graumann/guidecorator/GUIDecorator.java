...
public class GUIDecorator {
    ...
    private static final String WRAPPER_VIEW_PATH = RESOURCES_ROOT_PATH + "fxml/GUIWrapper.fxml";
    private static final String STYLE_CSS = RESOURCES_ROOT_PATH + "css/titlebar-default.css";
    ...
    private static final String URL_REPOSITORY = "https://github.com/BAAMMM1/JavaFX-Gui-Decorator";
